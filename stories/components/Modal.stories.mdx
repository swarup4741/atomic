    ...
    <Dialog className="modal" open={isOpen} onClose={() => setIsOpen(false)} {...args}>
      ...
      <div className="modal-layout">
        <div className="card p-6 space-y-6">
          ...
          <p>
            Cras semper lobortis lectus nec dictum. Duis tempor odio eu purus rutrum, hendrerit auctor leo lacinia. Phasellus sit amet nunc accumsan, molestie arcu eget, laoreet tortor.
          </p>
