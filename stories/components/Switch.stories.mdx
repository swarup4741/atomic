...
export const Template = ({ checked = false }) => {
...
export const TemplateLabeled = args => {
  ...
  return <>
    <Switch.Group as="div" className="input-group">
      ...
      <Switch.Label className="hint">Go ahead, give it a click!</Switch.Label>
    </Switch.Group>
  </>
}
...
<Canvas>
  <Story args={{ checked: true }} name="Active">
    {Template.bind({})}
  </Story>
</Canvas>
